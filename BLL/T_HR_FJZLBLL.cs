...
namespace BLL
{
    public partial class T_HR_FJZLBLL
    {
        #region 向数据库中增加一条数据
        /// <summary>
        ///BLL方法：向数据库中增加新一条新的T_HR_FJZL对象数据------>请传入对象，返回首行首列
        /// </summary>
        /// <returns></returns>
        public object Add(T_HR_FJZL model)
        {
            T_HR_FJZLDAL td = new T_HR_FJZLDAL();
       ...
       public int UpdateMultiterm(string updateDBColumnName, string updateDBColumnValue, string strAccord, params string[] strDBValues)
        ...
        #region 查找数据库中的一条数据
        /// <summary>
        ///BLL方法：查找数据库中的一条数据------>根据传入的参数查找数据,请传入数据库的列名以及查找对象的具体依据，返回T_HR_FJZL对象类型性数据
        /// </summary>
        /// <returns></returns>
        public T_HR_FJZL SelectSingleModelByReader(string strDBColumnName,string strSelId)
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            T_HR_FJZL T = Td.SelectSingleModelByReader(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            T_HR_FJZL T = Td.SelectSingleModelByAdapter(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        #region 查找数据库中的全部数据
        /// <summary>
        ///BLL方法：查找数据库中的全部数据------>返回IEnumerable&lt;T_HR_FJZL&gt;接口数据
        /// </summary>
        /// <returns></returns>
        public IEnumerable<T_HR_FJZL> SelectAllByReader()
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.SelectAllByReader();
            return i;
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.SelectAllByAdapter();
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：模糊查找数据库中符合条件的全部数据------>返回IEnumerable&lt;T_HR_FJZL&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.FuzzyQueryByReader(FJ_IDIsChecked,FJ_ID,RIDIsChecked,RID,ZLLXIsChecked,ZLLX,WJLXIsChecked,WJLX,ZLMCIsChecked,ZLMC,WJMCIsChecked,WJMC,ZLNRIsChecked,ZLNR,BZIsChecked,BZ,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.FuzzyQueryByAdapter(FJ_IDIsChecked,FJ_ID,RIDIsChecked,RID,ZLLXIsChecked,ZLLX,WJLXIsChecked,WJLX,ZLMCIsChecked,ZLMC,WJMCIsChecked,WJMC,ZLNRIsChecked,ZLNR,BZIsChecked,BZ,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：分页查找数据库中的数据(首页数据为第1页)not in select top...子查询方法[说明：strAccord为数据库列名，strASCorDESC请填写"ASC"或"DESC"]------>返回IEnumerable&lt;T_HR_FJZL&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.SelectT_HR_FJZLByPageUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            IEnumerable<T_HR_FJZL> i = Td.SelectT_HR_FJZLByPageUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：分页查找数据库中的数据(首页数据为第1页)Row_Number开窗函数方法------>根据传入的参数分页查找数据,请传入查找排序的具体依据[说明：strAccord为数据库列名，strASCorDESC请填写"ASC"或"DESC"],返回IEnumerable&lt;T_HR_FJZL&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
             return Td.SelectT_HR_FJZLByPageRow_NumberUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
             return Td.SelectT_HR_FJZLByPageRow_NumberUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            bool b = Td.T_HR_FJZLIsExist(strDBColumnName,strDBColumnValue);
            return b;
        }
        #endregion
        ...
        {
            T_HR_FJZLDAL Td = new T_HR_FJZLDAL();
            return Td.SelectT_HR_FJZLByPage_Proc(pageIndex, pageSize, out totalCount);
        }
        #endregion
    }
}