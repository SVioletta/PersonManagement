...
namespace BLL
{
    public partial class T_HR_GZLLBLL
    {
        #region 向数据库中增加一条数据
        /// <summary>
       ...
       public int UpdateMultiterm(string updateDBColumnName, string updateDBColumnValue, string strAccord, params string[] strDBValues)
        ...
        {
            T_HR_GZLLDAL Td = new T_HR_GZLLDAL();
            T_HR_GZLL T = Td.SelectSingleModelByAdapter(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        {
            T_HR_GZLLDAL Td = new T_HR_GZLLDAL();
            IEnumerable<T_HR_GZLL> i = Td.SelectAllByReader();
            return i;
        }
        #endregion
        ...
        {
            T_HR_GZLLDAL Td = new T_HR_GZLLDAL();
            IEnumerable<T_HR_GZLL> i = Td.FuzzyQueryByReader(GZLL_IDIsChecked,GZLL_ID,RIDIsChecked,RID,QSRQIsChecked,QSRQ,JZRQIsChecked,JZRQ,GZDWIsChecked,GZDW,ZWIsChecked,ZW,ZMRIsChecked,ZMR,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        {
            T_HR_GZLLDAL Td = new T_HR_GZLLDAL();
            IEnumerable<T_HR_GZLL> i = Td.SelectT_HR_GZLLByPageUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        {
            T_HR_GZLLDAL Td = new T_HR_GZLLDAL();
             return Td.SelectT_HR_GZLLByPageRow_NumberUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
