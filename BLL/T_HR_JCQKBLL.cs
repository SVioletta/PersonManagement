...
namespace BLL
{
    public partial class T_HR_JCQKBLL
    {
        #region 向数据库中增加一条数据
        /// <summary>
       ...
       public int UpdateMultiterm(string updateDBColumnName, string updateDBColumnValue, string strAccord, params string[] strDBValues)
        ...
        #region 查找数据库中的一条数据
        /// <summary>
        ///BLL方法：查找数据库中的一条数据------>根据传入的参数查找数据,请传入数据库的列名以及查找对象的具体依据，返回T_HR_JCQK对象类型性数据
        /// </summary>
        /// <returns></returns>
        public T_HR_JCQK SelectSingleModelByReader(string strDBColumnName,string strSelId)
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            T_HR_JCQK T = Td.SelectSingleModelByReader(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            T_HR_JCQK T = Td.SelectSingleModelByAdapter(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            IEnumerable<T_HR_JCQK> i = Td.SelectAllByReader();
            return i;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            IEnumerable<T_HR_JCQK> i = Td.FuzzyQueryByReader(JCQK_IDIsChecked,JCQK_ID,RIDIsChecked,RID,JCQKIsChecked,JCQK,JCDJIsChecked,JCDJ,JCDWIsChecked,JCDW,JCSJIsChecked,JCSJ,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            IEnumerable<T_HR_JCQK> i = Td.SelectT_HR_JCQKByPageUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
             return Td.SelectT_HR_JCQKByPageRow_NumberUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            bool b = Td.T_HR_JCQKIsExist(strDBColumnName,strDBColumnValue);
            return b;
        }
        #endregion
        ...
        {
            T_HR_JCQKDAL Td = new T_HR_JCQKDAL();
            return Td.SelectT_HR_JCQKByPage_Proc(pageIndex, pageSize, out totalCount);
        }
        #endregion
    }
}