...
namespace BLL
{
    public partial class T_HR_LDHTXXBLL
    {
        #region 向数据库中增加一条数据
        /// <summary>
       ...
       public int UpdateMultiterm(string updateDBColumnName, string updateDBColumnValue, string strAccord, params string[] strDBValues)
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            T_HR_LDHTXX T = Td.SelectSingleModelByAdapter(strDBColumnName,strSelId);
            return T;
        }
        #endregion
        ...
        #region 查找数据库中的全部数据
        /// <summary>
        ///BLL方法：查找数据库中的全部数据------>返回IEnumerable&lt;T_HR_LDHTXX&gt;接口数据
        /// </summary>
        /// <returns></returns>
        public IEnumerable<T_HR_LDHTXX> SelectAllByReader()
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.SelectAllByReader();
            return i;
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.SelectAllByAdapter();
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：模糊查找数据库中符合条件的全部数据------>返回IEnumerable&lt;T_HR_LDHTXX&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.FuzzyQueryByReader(HT_IDIsChecked,HT_ID,RIDIsChecked,RID,HTBHIsChecked,HTBH,HTLXIsChecked,HTLX,KSRQIsChecked,KSRQ,DQRQIsChecked,DQRQ,DASZDIsChecked,DASZD,LDSCIsChecked,LDSC,BLLYSXRQIsChecked,BLLYSXRQ,BLBXRQIsChecked,BLBXRQ,BLGJJRQIsChecked,BLGJJRQ,YXBSIsChecked,YXBS,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.FuzzyQueryByAdapter(HT_IDIsChecked,HT_ID,RIDIsChecked,RID,HTBHIsChecked,HTBH,HTLXIsChecked,HTLX,KSRQIsChecked,KSRQ,DQRQIsChecked,DQRQ,DASZDIsChecked,DASZD,LDSCIsChecked,LDSC,BLLYSXRQIsChecked,BLLYSXRQ,BLBXRQIsChecked,BLBXRQ,BLGJJRQIsChecked,BLGJJRQ,YXBSIsChecked,YXBS,GXRIDIsChecked,GXRID,GXRXMIsChecked,GXRXM,GXLXIsChecked,GXLX,GXYYIsChecked,GXYY,GXSJIsChecked,GXSJ);
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：分页查找数据库中的数据(首页数据为第1页)not in select top...子查询方法[说明：strAccord为数据库列名，strASCorDESC请填写"ASC"或"DESC"]------>返回IEnumerable&lt;T_HR_LDHTXX&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.SelectT_HR_LDHTXXByPageUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            IEnumerable<T_HR_LDHTXX> i = Td.SelectT_HR_LDHTXXByPageUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
            return i;
        }
        #endregion
        ...
        /// <summary>
        ///BLL方法：分页查找数据库中的数据(首页数据为第1页)Row_Number开窗函数方法------>根据传入的参数分页查找数据,请传入查找排序的具体依据[说明：strAccord为数据库列名，strASCorDESC请填写"ASC"或"DESC"],返回IEnumerable&lt;T_HR_LDHTXX&gt;接口数据
        /// </summary>
        /// <returns></returns>
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
             return Td.SelectT_HR_LDHTXXByPageRow_NumberUsingReader(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
             return Td.SelectT_HR_LDHTXXByPageRow_NumberUsingAdapter(pageIndex,pageSize,strAccord,strASCorDESC);
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            bool b = Td.T_HR_LDHTXXIsExist(strDBColumnName,strDBColumnValue);
            return b;
        }
        #endregion
        ...
        {
            T_HR_LDHTXXDAL Td = new T_HR_LDHTXXDAL();
            return Td.SelectT_HR_LDHTXXByPage_Proc(pageIndex, pageSize, out totalCount);
        }
        #endregion
    }
}